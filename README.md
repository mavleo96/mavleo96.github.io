...
The CV page content is generated from the JSON resume data located in [assets/json/resume.json](assets/json/resume.json). It follows the [JSON Resume](https://jsonresume.org/) standard for creating a CV programmatically.
